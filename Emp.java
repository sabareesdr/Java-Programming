...
class Employee2{
	  ...
	  public Employee2(String n, int y, int sal, String add){
	    name = n;
	    year = y;
	    salary = sal;
	    address = add;
	...
	class Emp{
	  public static void main(String[] args){
	    Employee2 e1 = new Employee2("Robert", 1994, 500000, "64C- WallsStreet");
	    Employee2 e2 = new Employee2("Sam", 2000, 740000, "68d- WallsStreet");
	    Employee2 e3 = new Employee2("John", 1999, 600000, "26B- WallsStreet");
